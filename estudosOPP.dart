...
void main() async {
  Future<String> futureCep = getCep('Rua Leonides Pommer');
  late String cep; //variavel que vai receber valor só depois

  cep = await futureCep; // espera o cep receber o futureCep e guarda na variavel "cep"
  print(cep);
}

Future<String> getCep(String rua) {
  return Future.value('32038129');
}
